...
export const hospitals: HospitalRecord[] = [
  {
    ...
    map: { x: 190, y: 132 },
    beds: [
      { type: 'Adult ICU', staffed: 54, available: 22, occupied: 32 },
  ...
  },
  {
    ...
    ambulanceQueue: 9,
    notes: 'Urban trauma center with stable ICU availability and active transfer intake.',
    map: { x: 128, y: 158 },
    beds: [
      { type: 'Adult ICU', staffed: 60, available: 20, occupied: 40 },
  ...
  },
  {
    ...
    map: { x: 215, y: 332 },
    beds: [
      { type: 'Adult ICU', staffed: 70, available: 25, occupied: 45 },
  ...
  },
  {
    ...
    ambulanceQueue: 5,
    notes: 'Academic medical center with stable ICU intake and coordinated air transport readiness.',
    map: { x: 230, y: 413 },
    beds: [
      { type: 'Adult ICU', staffed: 48, available: 16, occupied: 32 },
